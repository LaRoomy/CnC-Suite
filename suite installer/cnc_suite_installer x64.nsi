...
!define REDISTRIBUTABLE_FILENAME "redistributables\vc_redist.x64.exe"    ;MARK x86/x64

Name "CnC Suite ${VERSION}"
OutFile "installer_output\CnC Suite Installer x64 ${VERSION}.exe"       ;MARK: x86/x64

InstallDir "$PROGRAMFILES64\CnC Suite"                                    ;MARK: x86/x64 ($PROGRAMFILES64 for x64)
...
Section "Installer Section"
    ...
    File "exe_x64\CnC Suite.exe"                            ;MARK: x86/x64
